...
class ToolsUi(QDialog):
    ...
    def __init__(self, num):
        ...
        self.num = num
        # 目的是为了创建一个QCoreApplication对象。
        # QCoreApplication会构建出当前线程需要的事件驱动器，用于连接信号和槽，这样信号和槽就能够正常工作了。
    ...
    def ui_translate(self):
        ...
        self.setWindowTitle(self._translate("UDPCommunication", "UDPCommunication窗口%s" % self.num))
        self.comboBox_tcp.setItemText(0, self._translate("UDPCommunication", "UDP服务端"))
        self.comboBox_tcp.setItemText(1, self._translate("UDPCommunication", "UDP客户端"))
        self.pushButton_link.setText(self._translate("UDPCommunication", "连接网络"))
        self.pushButton_unlink.setText(self._translate("UDPCommunication", "断开网络"))
        self.pushButton_get_ip.setText(self._translate("UDPCommunication", "重新获取IP"))
        self.pushButton_clear.setText(self._translate("UDPCommunication", "清除消息"))
        self.pushButton_send.setText(self._translate("UDPCommunication", "发送"))
        self.pushButton_exit.setText(self._translate("UDPCommunication", "退出系统"))
        self.pushButton_dir.setText(self._translate("UDPCommunication", "选择路径"))
        self.pushButton_else.setText(self._translate("UDPCommunication", "窗口多开"))
        self.label_ip.setText(self._translate("UDPCommunication", "本机IP:"))
        self.label_port.setText(self._translate("UDPCommunication", "端口号:"))
        self.label_sendto.setText(self._translate("UDPCommunication", "目标IP:"))
        self.label_rev.setText(self._translate("UDPCommunication", "接收区域"))
        self.label_send.setText(self._translate("UDPCommunication", "发送区域"))
        self.label_dir.setText(self._translate("UDPCommunication", "请选择index.html所在的文件夹"))
        self.label_written.setText(self._translate("UDPCommunication", "Written by Wangler2333"))
    ...
    def combobox_change(self):
        ...
        if self.comboBox_tcp.currentIndex() == 0:
            ...
            self.label_port.setText(self._translate("UDP", "端口号:"))
        ...
        if self.comboBox_tcp.currentIndex() == 1:
            ...
            self.textEdit_send.show()
            self.label_port.setText(self._translate("UDP", "目标端口:"))
